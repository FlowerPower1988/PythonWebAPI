...
class IOrder_productManager(ABC):
    @abstractmethod
    def read_orders_products(self) -> list[Order_product]:
        pass
    @abstractmethod
    def create_order_product(self, new_order_product_values: Order_productValues) -> Order_product:
        pass
    @abstractmethod
    def read_order_product(self, order_id: int) -> Order_product:
        pass
    @abstractmethod
